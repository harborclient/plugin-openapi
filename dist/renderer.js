...
// node_modules/.pnpm/@harborclient+sdk@1.1.30_@babel+runtime@8.0.0_@codemirror+search@6.7.1_@codemirror+them_f5a921e594ac8a9fdb35874fc7795fe3/node_modules/@harborclient/sdk/dist/components/AsyncListState/LoadingMessage.js
...
// node_modules/.pnpm/@harborclient+sdk@1.1.30_@babel+runtime@8.0.0_@codemirror+search@6.7.1_@codemirror+them_f5a921e594ac8a9fdb35874fc7795fe3/node_modules/@harborclient/sdk/dist/ui/tokens.js
var METHOD_CLASSES = {
  get: "text-method-get",
...
function readOperationName(operation, method, path) {
...
function readFirstTag(operation) {
...
function readParameters(container) {
  const parameters = container.parameters;
  if (!Array.isArray(parameters)) {
    return [];
  }
  return parameters.filter(
    (parameter) => Boolean(parameter) && typeof parameter === "object"
  );
}
function readHeaderParameters(parameters) {
  const headers = {};
...
function readQueryParameters(parameters) {
  const params = [];
  for (const parameter of parameters) {
    const location = parameter.in;
    const name = parameter.name;
...
function readRequestBody(operation) {
  ...
  if (jsonContent && typeof jsonContent === "object") {
    const body = readJsonContent(jsonContent);
    if (body) {
      return { body, bodyType: "json" };
    }
  }
  const textContent = content["text/plain"] ?? content["text/html"];
  if (textContent && typeof textContent === "object") {
    const example = textContent.example;
    if (example != null) {
...
function readJsonContent(jsonContent) {
  ...
  const schema4 = jsonContent.schema;
  if (schema4 && typeof schema4 === "object") {
    const sample = sampleFromSchema(schema4);
    if (sample != null) {
...
function sampleFromSchema(schema4) {
  const directExample = schema4.example;
  if (directExample != null) {
  ...
  const schemaType = schema4.type;
  if (schemaType === "object" && schema4.properties && typeof schema4.properties === "object") {
    const result = {};
...
function operationsToCreateRequests(operations) {
      ...
      parsedSpec != null ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2", children: [
          ...
          parsedSpec.baseUrl ? /* @__PURE__ */ jsxs("p", { className: "text-[14px] text-muted", children: [
            "Base URL:",
            " ",
            /* @__PURE__ */ jsx("span", { className: "font-mono text-text-secondary", children: parsedSpec.baseUrl })
          ] }) : null
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-3", children: [
          ...
          /* @__PURE__ */ jsx(
            Button,
            {
              ...
              children: importing ? "Importing\u2026" : "Import collection"
            }
          )
        ] }),
            ...
            "section",
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 border-b border-separator px-3 py-2", children: [
                  ...
                  /* @__PURE__ */ jsxs("span", { className: "text-[14px] text-muted", children: [
                    "(",
                    operations.length,
                    ")"
                  ] })
